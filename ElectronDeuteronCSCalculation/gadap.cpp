...
using namespace std;
float  gadap (float , float , float (*pfun)(float), float );
float gadap2(float ,float , float (*pfl)(float), float (*pfu)(float), float (*pf)(float,float),float ); 
float dsum(float ,float , float , float , float ); 
float  fgadap (float x,float a0,float b0,float (*pfun)(float,float),float eps);
//**********************//

float gadap(float a0, float b0, float (*pfun)(float), float eps) {
// **********************************************************************    
//   
...
//                       SUPPLIED BY THE USER. (INPUT, float REAL FUNCTION) 
//               EPS   - DESIRED RELATIVE ACCURACY. IF SUM IS SMALL EPS  
//                       WILL BE ABSOLUTE ACCURACY INSTEAD. (INPUT, float REAL) 
//               SUM   - CALCULATED VALUE FOR THE INTEGRAL (OUTPUT, float REAL) 
//   PRECISION         - float  
//   REQ'D PROG'S      - C++   
...
//.......................................................................    
      ...
      float a[300], b[300], f1[300], f2[300], f3[300], s[300];
      int    n[300], l, i, ifu;
      float red, sum, c;
      float w1,u2,ss,sold;
 ...
 //************************************//
float  dsum(float f1f,float f2f,float f3f,float aa,float bb) {
...
float gadap2(float a0,float b0, float (*pfl)(float), float (*pfu)(float), float (*pf)(float,float),float eps) {  
     //       int iifu;
...
//.......................................................................    
      ...
      float a[300], b[300], f1[300], f2[300], f3[300], s[300];
      int   iifu,  n[300],l,i;
      float red,sum,c,x,ay,by,w1,u2,ss,sold;      
...
//      EXTERNAL F    
      ...
      float a[300], b[300], f1[300], f2[300], f3[300], s[300];
      int    iifu,n[300],l,i;
      float red,sum,c,ay,by,w1,u2,ss,sold,fgdp;      
